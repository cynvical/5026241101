...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Lexend+Deca:wght@100..900&family=Lexend:wght@100..900&family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap"
        rel="stylesheet">
    <style>
        .open-sans-judul {
    ...
    <div class="container">
        <div>
            <div class="jumbotron">
                ...
                <p class="lead">Welcome to Web Programming</p>
                <hr class="my-2">
            ...
            <div class="row">
                <div class="col-9">
                    <div>
                        ...
                        <p class="open-sans-judul fontintro">
                            ...
                            mengoptimalkan, dan
                            mengembangkan aset strategis Indonesia, sejalan dengan agenda jangka panjang transformasi
                            ekonomi nasional.
                        </p>
                    </div>
                </div>
                <div class="col-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <p><a href="#">Pelajari Lebih Lanjut</p>
                        </div>
                    </div>
                </div>
            </div>
